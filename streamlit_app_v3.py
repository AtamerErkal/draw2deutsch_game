    ...
    with col1:
        if st.session_state.current_round >= len(st.session_state.current_words):
            ...
            <div class="level-indicator">
                {emoji_target} Tur: {st.session_state.current_round + 1} / {len(st.session_state.current_words)}
            ...
            if st.session_state.timer_started:
                ...
                <div class="timer-display" style="background: linear-gradient(135deg, {timer_color}, {timer_color}AA);">
                    <div class="timer-value"> {emoji_target} {int(st.session_state.time_left)} saniye</div>
                </div>
                """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        if st.session_state.last_predictions:
            ...
            <div class="prediction-panel">
                <h4 style="color: var(--primary-blue); text-align: center; margin-bottom: 15px;">Pixinin Tahminleri</h4>
            """, unsafe_allow_html=True)
            ...
            <div class="game-card">
                ...
                <div style="text-align: center; margin: 15px 0;">
                    <div style="margin: 8px 0;">
                        ...
                        f"<span style='font-size: 1.3rem; color: var(--primary-green); font-weight: bold;'>{avg_score:.0f}</span>"
                    </div>
                    <div style="margin: 8px 0;">
...
# Giriş ekranı
    ...
    with col_info2:
        ...
        <div class="game-card">
            ...
            <p style="text-align: center;">İlk tahminde doğru = Kalan süre carpı 20 puan!</p>
        </div>
        """, unsafe_allow_html=True)
